import { ChevronRight, Database, LucideLayoutDashboard } from "lucide-react";
import React, { useMemo } from "react";
import { Link } from "react-router-dom";
import { BsBank } from "react-icons/bs";
import BankKYCForm from "./BankKYCForm";
import { useSelector } from "react-redux";
import { getDynamicStyles } from "../GlobalApi/Global";
import WithdrawalAmtTable from "../financial/WithdrawalAmtTable";
            ...
            <div className="lg:flex items-center gap-4">
              <div className="">
                <div className=" bg-[#f9fafb]/5 w-20 h-20 flex items-center justify-center rounded-3xl">
                  <BsBank className="text-[#fff] w-10 h-10 " />
                </div>
              </div>
              <div className="pb-5">
                <h6 className="text-white text-xl mb-2"> Bank KYC</h6>
                <h6 className="text-white">
                  Please submit your documents for Bank KYC verification to
                  complete your account registration and ensure secure
                  transactions.
                </h6>
              </div>
            </div>
