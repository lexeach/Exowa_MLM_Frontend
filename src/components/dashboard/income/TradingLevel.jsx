...
import TradingLevelTable from "./TradingLevelTable";
    ...
    <>
      <div className="overflow-hidden">
        <div className="max-h-screen overflow-x-auto py-5 lg:px-10 px-3">
          <CustompageHeader
            hometab="Income"
            innertab="Trading Level Income "
            decText="  Here, you can seen Your Trading Level Income Details!"
            decTitle="Trading  Level Income "
          />
          <div
