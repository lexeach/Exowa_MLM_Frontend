...
//   const activeLevelData = authData?.data?.mergedUserLevels || [];
...
//                         ? "linear-gradient(45deg, #003a9b, #886ece)"
...
//                       >
//                         {data?.is_active ? (
//                           <BsFillUnlockFill className="text-[#003A9B] font-extrabold text-[1.9rem]" />
//                         ) : (
...
//                           >
//                             <button
//                               className="px-1 py-[4px] text-[#003A9B]  bg-white rounded-lg"
...
//                           >
//                             <button
//                               className="px-[5px] py-[5px] text-[#003A9B]  bg-white rounded-lg"
