  ...
  const invoices = referralData
    ...
    ?.map((item) => {
      return {
        ...
        amount: isNaN(item?.amount) ? "-" : formatAmount(item?.amount),
        ...
        oldIncome: isNaN(item?.old_balance)
          ? "-"
          : formatAmount(item.old_balance),
        currentBalance: isNaN(item?.current_balance)
          ? "-"
    ...
    <div className="overflow-x-auto">
      ...
      <div className="mb-4 flex flex-wrap items-center justify-end gap-4">
        ...
        >
          ...
          <option value="referral_bonus">Sponsor</option>
          <option value="coreferral_bonus">Partner</option>
        </select>
        ...
        <table className="min-w-full table-auto border-collapse">
          <thead>
            <tr className="bg-gray-100 border-b" style={dynamicStylesInput}>
              ...
              <th className={headerCellClass}>Income(₹)</th>
              ...
              <th className={`${headerCellClass} min-w-[150px]`}>Payment Id</th>
              <th className={`${headerCellClass} min-w-[150px]`}>
                Old Income(₹)
              </th>
...
export default IncomeSummTable;
