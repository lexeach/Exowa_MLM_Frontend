import { ChevronRight, LucideLayoutDashboard, Network } from "lucide-react";
import React, { useMemo } from "react";
import { Link } from "react-router-dom";
import DirectTeamTable from "./DirectTeamTable";
            ...
            <div className="lg:flex items-center gap-4">
              <div className="">
                <div className=" bg-[#f9fafb]/5 w-20 h-20 flex items-center justify-center rounded-3xl">
                  <FaDirections className="text-[#fff] w-10 h-10 " />
                </div>
              </div>
              <div className="pb-5">
                <h6 className="text-white text-xl mb-2"> Direct Team</h6>
                <h6 className="text-white">
                  Here, you can seen all direct team data
                </h6>
              </div>
            </div>
          </div>
