import { ChevronRight, Database, LucideLayoutDashboard, Network } from "lucide-react";
import React, { useMemo } from "react";
import { Link } from "react-router-dom";
import BusinessHistoryTable from "./BusinessHistoryTable";
            ...
            <div className="lg:flex items-center gap-4">
              <div className="">
                <div className=" bg-[#f9fafb]/5 w-20 h-20 flex items-center justify-center rounded-3xl">
                  <IoMdBusiness className="text-[#fff] w-10 h-10 " />
                </div>
              </div>
              <div className="pb-5">
                <h6 className="text-white text-xl mb-2"> Business History</h6>
                <h6 className="text-white">
                  Here, you can seen Business History
                </h6>
              </div>
            </div>
          </div>
